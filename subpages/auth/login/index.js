...
var Test = (_temp2 = _class = function (_BaseComponent) {
  ...
  return Test;
}(_index.Component), _class.$$events = [], _class.$$componentPath = "auth/login/index", _temp2);
exports.default = Test;

Component(require('../../common/taro/@tarojs/taro-weapp/index.js').default.createComponent(Test, true));